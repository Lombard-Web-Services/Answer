...
class EncoderLayer(tf.keras.layers.Layer):
    ...
    def call(self, x, training, mask):
        ...
        """
        # START CODE HERE
        self_mha_output = self.mha(query=x, value=x, key=x, attention_mask=mask, training=training)  # Self attention (batch_size, input_seq_len, embedding_dim)
...
class DecoderLayer(tf.keras.layers.Layer):
    ...
    def call(self, x, enc_output, training, look_ahead_mask, padding_mask):
        ...
        # START CODE HERE
        mult_attn_out1, attn_weights_block1 = self.mha1(query=x, value=x, key=x,
        ...
        mult_attn_out2, attn_weights_block2 = self.mha2(query=Q1, value=enc_output, key=enc_output,
